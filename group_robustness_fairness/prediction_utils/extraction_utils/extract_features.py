...
import os
from group_robustness_fairness.prediction_utils.extraction_utils.featurizer import (
    BigQueryOMOPFeaturizer,
)
...
if __name__ == "__main__":
    ...
    featurizer = BigQueryOMOPFeaturizer(include_all_history=True, **args.__dict__)
